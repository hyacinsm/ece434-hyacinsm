 ...
 * @setup Therefore, this test LKM circuit assumes that an LED
 * is attached to GPIO 51 which is on P9_16 and the button is attached to GPIO 48 on P9_15.
...
static unsigned int gpioLED = 48;       ///< hard coding the LED gpio for this example to P9_23 (GPIO49)
static unsigned int gpioButton = 51;   ///< hard coding the button gpio for this example to P9_27 (GPIO115)
...
// gpio_set_value(gpioLED, ledOn);          // Not required as set by line above (here for reference)
   ...
   result = request_irq(irqNumber,             // The interrupt number requested
                        ...
                        (IRQF_TRIGGER_RISING|IRQF_TRIGGER_RISING),   // Interrupt on rising edge (button press, not release)

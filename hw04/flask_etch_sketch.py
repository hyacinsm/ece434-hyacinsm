...
#   Date: 1/10/24
#
# 	Runs an etch-sketch game on an LED matrix. Controlled by web server
#   Hosted on 1
#
#   Setup : run the ./etch_setup.sh to configure the needed pins
#   Wiring:	SDA is running on P9_22
...
@app.route("/")
def index():
    return render_template('etch_sketch_index.html')
